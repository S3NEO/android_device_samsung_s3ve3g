...
/**
 * RIL customization for Galaxy S3 Neo Dual-sim devices
 *
 * {@hide}
 */
public class TestMSM8226DSRIL extends RIL implements CommandsInterface {
    ...
    public TestMSM8226DSRIL(Context context, int networkMode, int cdmaSubscription,Integer instanceId) {
